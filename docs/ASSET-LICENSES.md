...
| `public/app-icon.svg`                         | PWA source icon              | Coffee Flavor Atlas project      | Project-created                                           | MIT for software interface use | No                                       | Yes           | Original abstract seed and coordinate mark; deterministic PNG derivatives are generated locally. |
| `public/icon-192.png` / `public/icon-512.png` | Installable PWA icons        | Coffee Flavor Atlas project      | Generated from the project-authored icon concept          | MIT for software interface use | No                                       | Yes           | Generated by `scripts/generate-pwa-icons.py`; no external image material.                        |
