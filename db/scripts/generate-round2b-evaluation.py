...
* adjudicated graded qrels keyed only by audit case and canonical concept;
    ...
    *,
    ...
    sql.extend(
        [
            ...
            "  IF EXISTS (SELECT 1 FROM _r2b_eval_judgment_seed AS seed LEFT JOIN kb.concept AS concept ON concept.concept_key = seed.concept_key AND concept.lifecycle_status_code = 'active' WHERE concept.concept_id IS NULL) THEN RAISE EXCEPTION 'Judged concept is absent or inactive'; END IF;\n",
