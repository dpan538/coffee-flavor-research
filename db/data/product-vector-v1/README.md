...
| `CN_CONSUMER_FLAVOR_LEXICON.tsv` | Consumer vocabulary: the owner's supplement matrix + fermented_winey terms (zh) and GACTT English consumer terms (`display_eligible` marks which may print on a card; all feed the utterance mapper). Chinese social-media expansion pending owner-provided corpus. |
