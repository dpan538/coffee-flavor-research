...
| `CN_CONSUMER_FLAVOR_LEXICON.tsv` | Consumer-facing vocabulary from the owner's supplement matrix (mainland-China roaster labels), each term with a primary dimension and optional canonical concept; Step 5 expands it from GACTT and social corpora. |
