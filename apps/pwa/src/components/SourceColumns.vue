...
<template>
  <figure class="w-full text-[#F4F1EA]" data-component="SourceColumns">
    <div class="gap-3" :class="zh ? 'flex items-start justify-between' : 'flex flex-col'">
      <div class="text-[13px] leading-[1.45] text-[#B9B4AA]" :class="zh ? 'max-w-[190px]' : ''">
      ...
      <ul class="text-[12px] leading-[1.4] shrink-0" :class="zh ? '' : 'grid grid-cols-2 gap-x-3'" data-index="panels">
